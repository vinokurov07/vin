...
Если не хочется скачивать 1 ГБ данных и обучать модель заново — используйте готовый образ из [Releases](https://github.com/<user>/recommender-system/releases). Он уже содержит все артефакты. Инструкция в основном README.

...
Если не хочется скачивать 1 ГБ данных и обучать модель заново — используйте готовый образ из [Releases](https://github.com/vinokurov07/vin/releases/tag/v1.0.0-project12). Он уже содержит все артефакты. Инструкция в основном README.
